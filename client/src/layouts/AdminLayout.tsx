...
import { 
  Users, Settings, BarChart2, Package, 
...
const menuItems: MenuItem[] = [
  {
    ...
    icon: <Users size={20} />,
    children: [
      { key: 'user-list', label: '用户列表', path: '/admin/users' },
      { key: 'user-stats', label: '用户统计', path: '/admin/users/stats' },
      { key: 'credit-manage', label: '信誉分管理', path: '/admin/users/credit' }
    ]
  },
  {
    key: 'games',
    ...
    children: [
      { key: 'game-list', label: '游戏列表', path: '/admin/games' },
      { key: 'game-stats', label: '游戏统计', path: '/admin/games/stats' }
    ]
  },
  {
    key: 'system',
    ...
    children: [
      { key: 'site-config', label: '网站配置', path: '/admin/settings' },
  ...
  },
  {
    ...
    children: [
      { key: 'daily-report', label: '日报表', path: '/admin/reports/daily' },
      { key: 'monthly-report', label: '月报表', path: '/admin/reports/monthly' }
    ]
  },
  {
    key: 'approvals',
    ...
    children: [
      { key: 'pending-approvals', label: '待审批', path: '/admin/approvals' },
      { key: 'approval-history', label: '审批历史', path: '/admin/approvals/history' }
    ]
  },
  {
    key: 'logs',
